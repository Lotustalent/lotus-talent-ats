        ...
        <div style={{padding:24,maxWidth:900,margin:"0 auto"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:24}}>
            <div>
              ...
              <Field label="Benefits" as="textarea" value={jobForm.benefits} onChange={v=>setJF("benefits",v)} placeholder={"Bonus scheme
25 vacation days
Pension
Hybrid working"} rows={3}/>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
            ...
            <div>
              ...
              <Field label="Language Requirements" as="textarea" value={jobForm.languages||""} onChange={v=>setJF("languages",v)} placeholder={"Japanese (Business Level)
English (Fluent)"} rows={2}/>
              ...
              <Field label="Requirements / Must-Haves" as="textarea" value={jobForm.requirements} onChange={v=>setJF("requirements",v)} rows={4} placeholder={"5+ years experience in…
Fluent in Japanese
Experience with…"}/>
